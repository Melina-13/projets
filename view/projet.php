...
<head>
    ...
    <link rel="stylesheet" href="public/css/projet_style.css">
</head>
<body>
    <div class="container">
        <?php include('navbar_menu.php'); ?>
        <div class="title">
            <h1> <img src="public/images/title3.WebP" loading="lazy" alt="titre de la rubrique Mes projets"></h1>
        ...
        <div id="modal1" class="modal">
            <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/tweeter.WebP" loading="lazy"  alt="capture d'ecran du projet ">
                ...
                <a href="#"><img class="github_modal" src="public/images/github_logo.WebP" loading="lazy" alt=""></a>
            </div>
        </div>
        ...
        <div id="modal2" class="modal">
          <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/lovly.WebP" loading="lazy" alt="capture d'ecran du projet ">
                ...
                <a href="http"><img class="github_modal" src="public/images/github_logo.WebP" loading="lazy" alt=""></a>
          </div>
        </div>
        ...
        <div id="modal3" class="modal">
          <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/cinemascoop.WebP" loading="lazy" alt="capture d'ecran du projet ">
         ...
         <div id="modal4" class="modal">
            <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/puissance4.WebP" loading="lazy" alt="capture d'ecran du projet ">
        ...
        <div id="modal5" class="modal">
          <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/morpion.WebP" loading="lazy" alt="capture d'ecran du projet ">
        ...
        <div id="modal6" class="modal">
          <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/quizz.WebP" loading="lazy" alt="capture d'ecran du projet ">
         ...
         <div id="modal7" class="modal">
            <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/to_do_list.WebP" loading="lazy" alt="capture d'ecran du projet ">
        ...
        <div id="modal8" class="modal">
          <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/editeur.WebP" alt="capture d'ecran du projet ">
        ...
        <div id="modal9" class="modal">
          <div class="modal-content">
                ...
                <img class="img_modal" src="public/images/pmride.WebP" loading="lazy" alt="capture d'ecran du projet ">
    ...
    <script src="public/js/projet_card.js"></script>
    <script src="public/js/projet_modal.js"></script>
</body>
</html>